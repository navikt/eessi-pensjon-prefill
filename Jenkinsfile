...
node {
    ...
    try {
        ...
        stage("checkout") {
            ...
            github.commitStatus("pending", "navikt/eessi-pensjon-fagmodul", appToken, commitHash)
        }
        ...
        stage("release") {
            ...
            sh "make release"
            sh "git push --tags https://x-access-token:$appToken@github.com/navikt/eessi-pensjon-fagmodul HEAD:master"
        }
