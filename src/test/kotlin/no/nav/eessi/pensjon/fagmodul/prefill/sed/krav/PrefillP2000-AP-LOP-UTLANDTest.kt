...
class `PrefillP2000-AP-LOP-UTLANDTest` : AbstractPrefillIntegrationTestHelper() {
    ...
    @Before
    fun setup() {
        val pensionDataFromPEN = pensjonsDataFraPEN("AP-LOP-21644722.xml")
        ...
        prefillData = generatePrefillData("P2000", "02345678901", sakId = pesysSaksnr)
