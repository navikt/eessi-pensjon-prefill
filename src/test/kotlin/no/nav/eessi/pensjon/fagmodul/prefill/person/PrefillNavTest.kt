...
class PrefillNavTest {
    ...
    fun `prefill med tom respons fra TPS`() {
        ...
        val prefillData = PrefillDataModel(penSaksnummer = somePenSaksnr).apply {
            norskIdent = personensPin
        }
