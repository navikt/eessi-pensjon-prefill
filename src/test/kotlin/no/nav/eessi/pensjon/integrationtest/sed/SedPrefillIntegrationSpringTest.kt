...
class SedPrefillIntegrationSpringTest {
    ...
    fun `prefill sed P6000 P_BUC_02 Gjenlevende har med avdod skal returnere en gyldig SED`() {
        ...
        val apijson = dummyApijson(sakid = "22874955", vedtakid = "987654321122355466", aktoerId = AKTOER_ID, sedType = P6000, buc = P_BUC_02.name, fnravdod = FNR_VOKSEN_4)
    ...
    fun `prefill sed P6000 P_BUC_01 Alderpensjon med avslag skal returnere en gyldig SED`() {
        ...
        every { kodeverkClient.finnLandkode(any()) } returns "QX"
        val apijson = dummyApijson( sakid = "22874955", vedtakid = "123123423423", aktoerId = AKTOER_ID, sedType = P6000, buc = P_BUC_01.name)
    ...
    fun `prefill sed P3000_SE Gjenlevende har med avdod skal returnere en gyldig SED`() {
        ...
        val apijson = dummyApijson(sakid = "22874955", vedtakid = "9876543211", aktoerId = AKTOER_ID, sedType = P3000_SE, buc = P_BUC_10.name,  fnravdod = FNR_VOKSEN_4)
    ...
    fun `prefill sed P5000 med Gjenlevende og avdod skal returnere en gyldig SED`() {
        ...
        val apijson = dummyApijson(sakid = "22874955", vedtakid = "9876543211", aktoerId = AKTOER_ID, sedType = P5000, buc = P_BUC_10.name,  fnravdod = FNR_VOKSEN_4)
    ...
    fun `prefill sed P4000 med forsikret person skal returnere en gyldig SED`() {
        ...
        every { kodeverkClient.finnLandkode(any()) } returns "QX"
        val apijson = dummyApijson(sakid = "22874955", vedtakid = "9876543211", aktoerId = AKTOER_ID, sedType = P4000, buc = P_BUC_05.name)
    ...
    fun `prefill sed med ALDERP uten korrekt kravårsak skal kaste en Exception`() {
        ...
        val apijson = dummyApijson(sakid = "20541862", aktoerId = AKTOER_ID, sedType = P2100, buc = P_BUC_02.name, fnravdod = FNR_VOKSEN_4)
...
fun dummyApijson(sakid: String, vedtakid: String? = null, aktoerId: String, sedType: SedType = P2000, buc: String? = P_BUC_06.name, fnravdod: String? = null, kravtype: KravType? = null, kravdato: String? = null, payload: String? = null): String {
