...
class SedPrefillPDLIntegrationSpringTest {
    ...
    fun `prefill sed P2000 alder return valid sedjson`() {
        every { pesysService.hentP2000data(any(), any()) } returns XmlToP2xxxMapper.readP2000FromXml("/pensjonsinformasjon/krav/P2000-AP-UP-21337890.xml")
        every { kodeverkClient.finnLandkode(any()) } returns "QX"
    ...
    fun `prefill sed P2100 P_BUC_02 Gjenlevende har med avdod skal returnere en gyldig SED`() {
        ...
        every { pesysService.hentP2100data(any(), any()) } returns XmlToP2xxxMapper.readP2100FromXml("/pensjonsinformasjon/krav/P2100-GL-UTL-INNV.xml")
