...
class SedPrefillPDLIntegrationSpringTest {
    ...
    fun `prefill sed P2100 P_BUC_02 Gjenlevende har med avdod skal returnere en gyldig SED`() {
        ...
        every { krrService.hentPersonerFraKrr(eq(FNR_VOKSEN)) } returns KrrPerson(false,"melleby1@melby.no","22603511")
        every { krrService.hentPersonerFraKrr(eq(FNR_VOKSEN_2)) } returns KrrPerson(false,"melleby2@melby.no","22603522")
