...
class PrefillP6000Pensjon_GJENLEV_Test {
    ...
    fun `forventet korrekt utfylling av Pensjon objekt på Gjenlevendepensjon`() {
        every { pesysService.hentP6000data(any()) } returns XmlToP6000Mapper.readP6000FromXml("/pensjonsinformasjon/vedtak/P6000-GP-401.xml")
    ...
    fun `forventet korrekt utfylt P6000 gjenlevende ikke bosat utland (avdød bodd i utland)`() {
        every { pesysService.hentP6000data(any()) } returns XmlToP6000Mapper.readP6000FromXml("/pensjonsinformasjon/vedtak/P6000-GP-IkkeUtland.xml")
