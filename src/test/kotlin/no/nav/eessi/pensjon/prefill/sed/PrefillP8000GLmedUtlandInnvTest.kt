...
class PrefillP8000GLmedUtlandInnvTest {
    ...
    fun setup() {
        ...
        prefillData = PrefillDataModelMother.initialPrefillDataModel(SedType.SEDTYPE_P8000, personFnr, penSaksnummer = pesysSaksnummer, avdod = PersonInfo(avdodPersonFnr, "112233445566"))
