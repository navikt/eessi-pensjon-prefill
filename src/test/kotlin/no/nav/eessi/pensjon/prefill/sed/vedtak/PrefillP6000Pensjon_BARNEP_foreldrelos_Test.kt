...
class PrefillP6000Pensjon_BARNEP_foreldrelos_Test {
    ...
    fun `forventet korrekt utfylling av Pensjon objekt på Gjenlevendepensjon`() {
        ...
        prefillData = PrefillDataModelMother.initialPrefillDataModel(SedType.SEDTYPE_P6000, personFnr, penSaksnummer = "22580170", vedtakId = "12312312", avdod = PersonInfo(avdodPersonFnr, "112233445566"))
