...
class KravHistorikkHelper {
    ...
    fun hentYtelsePerMaanedDenSisteFraKrav(fraKravhistorik: V1KravHistorikk, pensak: V1Sak): V1YtelsePerMaaned {
    ...
    fun hentKravHistorikkSisteRevurdering(pensak: V1Sak): V1KravHistorikk {
    ...
    fun hentKravHistorikkForsteGangsBehandlingUtlandEllerForsteGang(pensak: V1Sak): V1KravHistorikk {
    ...
    fun hentKravHistorikkMedKravStatusTilBehandling(pensak: V1Sak): V1KravHistorikk {
        val sortList = sortertKravHistorikk(pensak)
        sortList.forEach {
