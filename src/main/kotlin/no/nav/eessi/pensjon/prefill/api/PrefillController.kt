...
class PrefillController(
    ...
    fun prefillDocument(  @RequestBody request: ApiRequest): String {
        ...
        val pensjonCollection = innhentingService.hentPensjoninformasjonCollection(dataModel)

        return prefillService.prefillSedtoJson(dataModel, "v4.2", personcollection, pensjonCollection)
    }
}
